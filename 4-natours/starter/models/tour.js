...
const tourSchema = new mongoose.Schema(
  {
    name: {
      ...
      minlength: [10, 'A tour name should be more than 10 characters'],
    ...
    difficulty: {
      ...
      enum: {
        ...
        message: 'Difficulty can only be of value, easy, medium, difficult',
      },
    },
    ratingsAverage: {
      type: Number,
      default: 0,
      min: [0.1, 'Ratings must be bigger than 0.1'],
      max: [5.0, 'Ratings cannot be bigger than 5'],
    },
    ratingsQuantity: {
      type: Number,
      default: 0,
    ...
    discount: {
      ...
      validate: {
        validator: function (price) {
          return price < this.price; // This keyword only ref to current doc when creating a new doc, doesn't work for update.
        },
